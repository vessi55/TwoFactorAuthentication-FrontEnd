...
class Articles extends Component {
    ...
    getMyArticles() {
        ...
        let email = localStorage.getItem(AUTHENTICATED_USER_EMAIL)

        ArticleService.getMyArticles(email)
        .then(response => {
            this.setState({
    ...
    handleShowButtonChange (articleId) {
                        ...
                        <Card className="card">
                            <div className="container">
                                <div className="row">
                                    ...
                                    <div className="col-md-8">
                                        <CardContent className="card-body">
                                            ...
                                            <button className="showMoreButton" onClick={() => this.handleShowButtonChange(article.uid)}>Покажи повече</button>
                                        </CardContent>
                                    </div>
                                </div>
                                <div>
                                <PopUp
                                    ...
                                    closeAction={() => this.handleShowButtonChange(article.uid)}
                                    buttonAction={() => this.handleShowButtonChange(article.uid)} buttonName='Затвори'
                                    >
                                </PopUp>
                                </div>
                            </div>
